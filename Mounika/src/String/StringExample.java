            ...
            String str4 = new String("Madhu");
                ...
                String str5 = new String("madhu");
                    ...
                    String str6 = new String("madhu");
                        ...
                        System.out.println(str6.charAt(0));//m
                        System.out.println(str6.charAt(2));//d
                        String s3 = " Namaste";
                            System.out.println(s3.trim());// eleminated the white spaces before and after the string
                            String s4 = "Hello ALL";
                                System.out.println(s4.trim());// not removed white spcae in between
                                String s5 = "Hello ";
                                    System.out.println(s5.trim());// removes the white space after the string
                                    ...
                                    System.out.println(s5.length());//prints the length of string//6
                                        ...
                                        String s6 = str7.intern();
                                            System.out.println(s6); // it given the value of the str7
                                            int i = 14;
                                            String str8 = String.valueOf(i);// i value is assigned to str8
                                                ...
                                                System.out.println(s7.contains("welcome everyone. Welcome"));//fale
                                                System.out.println(s7.contains("Heloo"));//false
                                               System.out.println(String.format("name is %s", str7));
                                               System.out.println(s7.isEmpty());//false checks the length() is 0 then only true
                                               System.out.println(s7.isBlank());//false checks is string is empty or white space, return true
                                               System.out.println(s7.substring(8, 11));// prints the char of paticular given index characters in string 
                                                System.out.println(s7.substring(0));// prints from the given index
